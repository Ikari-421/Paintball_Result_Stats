...
describe('Game', () => {
    ...
    describe('GameTimer', () => {
        ...
        it('should throw error for negative time', () => {
            expect(() => new GameTimer(-10, false)).toThrow('Remaining time cannot be negative');
        });
    ...
    describe('create', () => {
        ...
        it('should throw error if id is empty', () => {
            expect(() => Game.create('', 'field-1', matchup, gameMode)).toThrow('Game ID cannot be empty');
        });
    });
    ...
    describe('start', () => {
        ...
        it('should throw error if game is not in NOT_STARTED status', () => {
            ...
            expect(() => started.start()).toThrow('Game can only be started from NOT_STARTED status');
        });
    });
    ...
    describe('pause', () => {
        ...
        it('should throw error if game is not running', () => {
            ...
            expect(() => game.pause()).toThrow('Game can only be paused when RUNNING');
        });
    });
    ...
    describe('resume', () => {
        ...
        it('should throw error if game is not in BREAK status', () => {
            ...
            expect(() => game.resume()).toThrow('Game can only be resumed from BREAK status');
        });
    });
    ...
    describe('updateScore', () => {
        ...
        it('should throw error when trying to update score while running', () => {
            ...
            expect(() => started.updateScore(newScore)).toThrow('Cannot modify score while game is running');
        });
    });
    ...
    describe('updateTimer', () => {
        ...
        it('should throw error when trying to update timer while running', () => {
            ...
            expect(() => started.updateTimer(newTimer)).toThrow('Cannot modify timer while game is running');
        });
    });
});
